...
<body>
	<h1>Les statistiques d'Avito pour Aujourd'hui</h1>
	<table>		
		<tr>
			<th>Catégorie</th>
			<th>Nombre d'annonces</th>
		</tr>
		<c:forEach items="${requestScope.statisticsWeek}" var="statistic" varStatus="boucle">		
			<tr>
				<td>${statistic.key}</td>	
	...
	<canvas id="myChart"></canvas>
		<script>			
			...
			var categories = '${requestScope.keys}';
			...
			var colors  = ['#00CED1','#FF1493','#FFD700','#0000CD','#32CD32','#FF6347'];
